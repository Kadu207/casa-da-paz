...
const tabs: {
  ...
  { to: '/app/financeiro/pagamentos', labelKey: 'erp.financeiro.tab.pagamentos', resource: 'contas_pagar' },
  { to: '/app/financeiro/contas-pagar', labelKey: 'erp.financeiro.tab.contasPagar', resource: 'contas_pagar' },
  { to: '/app/financeiro/recorrencia', labelKey: 'erp.financeiro.tab.recorrencia', resource: 'recorrencia' },
  { to: '/app/financeiro/contribuintes', labelKey: 'erp.financeiro.tab.contribuintes', resource: 'contribuintes' },
  { to: '/app/financeiro/dre', labelKey: 'erp.financeiro.tab.dre', resource: 'dre' },
  { to: '/app/financeiro/ofx', labelKey: 'erp.financeiro.tab.ofx', resource: 'conciliacao_bancaria' },
