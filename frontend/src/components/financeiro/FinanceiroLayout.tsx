...
const tabs: { to: string; labelKey: ErpTranslationKey; end?: boolean; showPendingBadge?: boolean }[] = [
  ...
  { to: '/app/financeiro/alertas', labelKey: 'erp.financeiro.tab.alertas', showPendingBadge: true },
];
